...
<body translate="no">
        ...
        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          <g id="Front">
            ...
            <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">0123 4567 8910
              1112</text>
            <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">insert name</text>
      ...
      <div class="back">
        <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          <g id="Back">
            ...
            <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">insert name</text>
          </g>
        </svg>
      </div>
    </div>
  ...
  <div class="form-container">
    ...
    <div class="field-container">
      <button class="" onclick="show();" type="submit">Pay RM <?php echo $_GET['total'] ?></button>
    </div>
    ...
    window.onload = function () {
      ...
      name.addEventListener('input', function () {
        if (name.value.length == 0) {
          document.getElementById('svgname').innerHTML = 'insert name';
          document.getElementById('svgnameback').innerHTML = 'insert name';
        } else {

...
<head>
    ...
    <title>The Sole Footwear - <?= $title ?></title>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="no_search dropdown"><a href="#"><span>Category</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <?php
                            foreach ($categories['main_category'] as $category) : ?>
                                <?php if (count($category['sub_category']) > 0) : ?>
                                    <li class="dropdown"><a href="#"><?= $category['category_name'] ?> <i class="bi bi-chevron-right"></i></a>
                                        <ul>
                    ...
                    <li class="no_search"><a href="">Contact</a></li>
                    <li class="no_search"><a href="">Give Order</a></li>
                    <li class="no_search"><a _target='blank' href="http://localhost:3000/">Customize</a></li>
                    <li class="no_search">
                        <a href="#" class="search"><i class="fas fa-search"></i></a>
                    </li>
                    <li class="top-search d-none">
                    ...
                    <li class="no_search">
                        <a href="cart.php" class="cart"><i class="fas fa-shopping-cart"></i>&nbsp;&nbsp; <span id="cart_item" class="badge bg-danger rounded-pill" style="position: absolute; top: -2px; right: -8px;">0</span></a>
                    </li>
                    <?php if (!isset($_SESSION['user']['customer'])) : ?>
                        <li><a href="sign_in.php" class="getstarted">Sign Up | Sign in </a></li>
                    <?php else : ?>
                        <li class="no_search dropdown"><a href="#"><span><?= $_SESSION['user']['customer']['user_name'] ?></span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
